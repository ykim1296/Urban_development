...
fl_big_cities <- read.csv("D:/Research/Dr.Safikhani/Urban Development_1/R codes/Florida_big_cities.csv")
```
...
#ggtitle("Development Trend in the Number of Vacant Parcels in 2024 from RF")
...
#ggtitle("Areas in which NVACANT = 0 (2024) and NSINGLERES = 1 (2024) from RF")
